...
/// A type-erased way to store a screen's name. Generated by calling
/// [bevy::reflect::enum_hash] on the screen enum variant.
#[derive(Deref, DerefMut, Copy, Clone, Debug, PartialEq, Eq, Hash, Reflect)]
pub struct ScreenName(pub u64);
impl From<u64> for ScreenName {
...
pub struct CurrentScreen(pub ScreenName);
impl From<ScreenName> for CurrentScreen {
...
pub struct NextScreen(pub Option<ScreenName>);
...
pub struct SwitchToScreen(pub ScreenName);
